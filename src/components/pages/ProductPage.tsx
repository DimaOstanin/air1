...
export const ProductPage: React.FC = () => {
  ...
  const goodToUpdate = useRef<GoodsType>();
    ...
    <Box>
      {product && (
        <Box key={product.id} justifyContent="center" sx={{ width: '100%', maxWidth: '100%', maxHeight: '100%' }}>
          {deleteButton &&
            <Box >
              <Button onClick={() => dispatch(goodsActions.removeGoods(id))} sx={{marginRight:"10px"}} variant="contained">DELETE</Button>
              {/* <Button onClick={actualUpdate} sx={{marginRight:"10px"}} variant="contained">EDIT</Button> */}
            </Box>
